<img src="./docs/imgs/made-with-solidity.svg" href="https://forthebadge.com">
<img src="https://forthebadge.com/images/badges/built-with-love.svg" href="https://forthebadge.com">

<h1 align="center" style="display: block; font-size: 2.5em; font-weight: bold; margin-block-start: 1em; margin-block-end: 1em;">
<a name="logo" href="https://harmony-one-web.vercel.app/"><img align="center" src="./docs/imgs/logo.png" alt="LocoMoco Home" style="width:70%;height:50%"/></a>
</h1>


# LocoMoco

## Introduction[![](./docs/imgs/pin.svg)](#introduction)
...
## Table of contents[![](./docs/imgs/pin.svg)](#table-of-contents)
...
## Motivation[![](./docs/imgs/pin.svg)](#motivation)
...
## How it works[![](./docs/imgs/pin.svg)](#how-it-works)

![](./docs/imgs/how-it-works.png)

---

## Composition[![](./docs/imgs/pin.svg)](#composition)
...
## Why Harmony?[![](./docs/imgs/pin.svg)](#harmony)
...
## Use cases and benefits[![](./docs/imgs/pin.svg)](#use-cases-and-benefits)
...
![Food Price Changes](./docs/imgs/food-price-change.png)
...
![Crypto POS](./docs/imgs/crypto-pos.jpeg)
...
![Outdoor Seating](./docs/imgs/outdoor-seating.jpeg)

---

## Examples[![](./docs/imgs/pin.svg)](#examples)

[![pizza shop](./docs/imgs/pizza-shop-website.png)](https://harmony-one-web.vercel.app/pizzacheckout)

---

## How to Deploy Smart Contract[![](./docs/imgs/pin.svg)](#deployment)
...
## Licensing[![](./docs/imgs/pin.svg)](#licensing)
